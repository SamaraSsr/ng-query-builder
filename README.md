...
The goal of this project is to enable Angular 14+ support for the original [angular2-query-builder](https://github.com/zebzhao/Angular-QueryBuilder).
...
This project uses code from [Angular-QueryBuilder](https://github.com/designermanjeets/Angular-QueryBuilder)
a fork of [ngx-angular-query-builder](https://github.com/raysuelzer/ngx-angular-query-builder) both developed under the MIT License.
